...
_board_state.json updated: 2026-06-29T15:17:49Z · 97 items_
...
**90 landed on `main`** · **4 open** (in-CI / todo / planned / backlog).

## Outstanding work

| Status | Priority | Arch | Item | Issue | PR |
|---|---|---|---|---|---|
| In Progress | P3 | None | Varied wild flora — pine stands, berry bushes & wildflower meadows | — | — |
